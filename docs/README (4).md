...
👉 **Arquitectura completa del proyecto (diagramas, flujo de datos): [`docs/ARCHITECTURE.md`](./docs/ARCHITECTURE.md)**
👉 **Diseño de la base de datos y buenas prácticas aplicadas: [`BD proy/ecosmart-fields-main/supabase/DATABASE.md`](./BD%20proy/ecosmart-fields-main/supabase/DATABASE.md)**
...
│       ├── supabase/
│       │   ├── DATABASE.md          # diseño, decisiones y buenas prácticas de la BD
│       │   ├── schema-reference.sql  # esquema Postgres versionado (llaves, checks, índices)
│       │   ├── seed-demo-data.sql
